...
console.log('Start a run that finishes without pausing:\n');
console.log(`  ${prefix}npm run webhook -- "just checking in on the roadmap"\n`);
console.log('Start one that pauses at the approval gate:\n');
console.log(`  ${prefix}npm run webhook -- "the checkout page is completely broken and we are losing orders"\n`);
